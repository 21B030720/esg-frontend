...
import LabDetailsWithoutPayload from './components/LabDetailsWithoutPayload';
import LabsListWithoutPayload from './components/LabsListWithoutPayload';
...
const LaboratoriesWithoutPayload = () => {
	...
	return (
		<div>
			...
			<div className="labs-page">
				<LabsListWithoutPayload labs={fakeLabs} onSelectLab={handleLabSelect} />
				{selectedLab && (
					<LabDetailsWithoutPayload
						lab={selectedLab}
...
export default LaboratoriesWithoutPayload;