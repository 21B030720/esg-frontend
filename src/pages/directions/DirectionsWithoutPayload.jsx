...
import DirectionsListWithoutPayload from './components/DirectionsListWithoutPayload';
import DirectionDetailsWithoutPayload from './components/DirectionDetailsWithoutPayload';
...
const DirectionsWithoutPayload = () => {
	...
	const handleNextDirection = () => {
		const currentIndex = fakeDirections.findIndex(
	...
	const handlePreviousDirection = () => {
		...
		const prevIndex =
			(currentIndex - 1 + fakeDirections.length) % fakeDirections.length;
...
export default DirectionsWithoutPayload;